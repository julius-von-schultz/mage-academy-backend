...
export interface ApiArrayIntEntryArrayIntEntry
  extends Struct.CollectionTypeSchema {
  collectionName: 'array_int_entries';
  info: {
    description: '';
    displayName: 'ArrayIntEntry';
    pluralName: 'array-int-entries';
    singularName: 'array-int-entry';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    intEntry: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiArrayStringEntryArrayStringEntry
  extends Struct.CollectionTypeSchema {
  collectionName: 'array_string_entries';
  info: {
    description: '';
    displayName: 'ArrayStringEntry';
    pluralName: 'array-string-entries';
    singularName: 'array-string-entry';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    arrayEntry: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estimatedTimeInMins: Schema.Attribute.Integer &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::array-int-entry.array-int-entry': ApiArrayIntEntryArrayIntEntry;
      'api::array-string-entry.array-string-entry': ApiArrayStringEntryArrayStringEntry;
